...
{
    DBG("Instantiating StandaloneFilterApp via our very own StandaloneFilter.cpp");
...
{
    DBG("Instantiating juce::StandaloneFilterWindow via our very own StandaloneFilter.cpp");
